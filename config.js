var config = {
    ...
    accessToken: '<YOUR_ACCESS_TOKEN>', // replace with a secure token retrieval mechanism
    showMarkers: false,
    markerColor: '#3FB1CE',
    inset: true,
    insetOptions: {
    ...
    chapters: [
        {
            ...
            hidden: false,
            title: 'Introduction',
            image: './assets/thesis_image.jpg', // check path
            ...
            location: {
                center: [-90, 35],
                zoom: 4, // adjusted zoom for better focus
                pitch: 0,
                bearing: 0
            },
            mapAnimation: 'flyTo'
        },
        {
            ...
            image: './assets/alice_walker_childhood_home.jpg', // check path
        ...
        },
        {
            ...
            image: './assets/firestone_farm.jpg', // check path
            description: 'In contrast, *Their Eyes Were Watching God* had a higher male-to-female buying ratio, particularly in Eatonville and Orlando. Although male interactions remained dominant, Florida\'s geography demonstrated greater economic agency among women than in the other novels. Their Eyes Were Watching God gives a detailed example of how male control of place translates into power. Joe Starks\' acquisition of 200 acres in Eatonville and decision to put a streetlamp are symbolic acts: "But Ah wants to have a speech with the rest of you. But it\'s pointless for me to try to stay dry for that long. The rest of you can stand around and look." This is more than just buying land; it\'s about establishing authority and being visible. Eatonville has the closest male-to-female buying ratio in the sample, yet Joe remains the major player, utilizing his economic power to quiet Janie. The balance of transactions may appear better on paper, but the qualitative experience of power remains unequal.',
            location: {
        ...
        },
        {
            ...
            image: './assets/as_i_lay_dying.jpg', // check path
        ...
        },
        {
            ...
            image: './assets/color_purple_field.jpg', // check path
        ...
        },
        {
            ...
            image: './assets/salvage_dogfight.jpg', // check path
        ...
        },
        {
            ...
            image: './assets/gender_trade_graphic.jpg', // check path
        ...
        },
        {
            ...
            image: './assets/gap.jpg', // check path
        ...
        },
        {
            ...
            image: './assets/house_interior.jpg', // check path
        ...
        },
        {
            ...
            image: './assets/color_purple_reunion.jpg', // check path
